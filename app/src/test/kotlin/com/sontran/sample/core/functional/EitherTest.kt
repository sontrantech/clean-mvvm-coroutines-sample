...
import com.sontran.sample.core.functional.Either.Right
    ...
    fun `Either Right should return correct type`() {
        ...
        result.fold({},
                { right ->
                    ...
                    right shouldEqualTo "sontran"
                })
    }

    @Test
    fun `Either Left should return correct type`() {
        val result = Left("sontran")
